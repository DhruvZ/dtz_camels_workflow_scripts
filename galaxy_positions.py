...
run_id = sys.argv[1]
snap = int(sys.argv[2])
snap_dir = f'/orange/narayanan/d.zimmerman/camels_results/filtered/{run_id}/snap{snap}/'
outfile = f'/orange/narayanan/d.zimmerman/camels_results/filtered/{run_id}/snap{snap}/snap{snap}_gal_positions.npz'
################
