...
#HOME INFORMATION
#===============================================
pd_source_dir = '/home/d.zimmerman/powderday/'

#===============================================
#RESOLUTION KEYWORDS
#===============================================
oref = 0 # over refine factor - should typically be set to 0
n_ref = 1 # when n_particles > n_ref, octree refines further
...
n_processes = 4 # number of pool processes to run for stellar SED generation
n_MPI_processes = 4 # number of MPI tasks to run. for TORQUE this is
...
SKIRT_DATA_DUMP = False # if set, various data files useful for running SKIRT are saved.
