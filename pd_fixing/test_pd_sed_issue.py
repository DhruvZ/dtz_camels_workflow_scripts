...
plt.xscale('log')
plt.yscale('log')
plt.savefig(f'/home/d.zimmerman/figures/test_pd_gas_grid_{snap}_v1.png')
plt.close()
...
plt.ylabel('sed nref1/nref32 flux ratio')
plt.title(f"z={np.round(caes_file.simulation.redshift,2)}")
plt.ylim(10**-1,10**1)
plt.xscale('log')
plt.yscale('log')
plt.savefig(f'/home/d.zimmerman/figures/test_pd_sed_rat_{snap}_v1.png')
plt.close()
